...
## How it workds
The original bioclimatic data stored in [WorldClim](https://worldclim.org/) is stored in [TIFF]{https://en.wikipedia.org/wiki/TIFF} format. envData provides a bridge
