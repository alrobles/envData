...
The original bioclimatic data in [WorldClim](https://worldclim.org/) is
stored in \[TIFF\]{<https://en.wikipedia.org/wiki/TIFF>} format.
`envData` provides a bridge to acces this data storing on a
...
<figure>
<img src="./man/figures/envData_diagram.png"
